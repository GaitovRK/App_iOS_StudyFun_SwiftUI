...
//        view.contentInsetAdjustmentBehavior = .never
    ...
    func updateUIView(_ uiView: UIScrollView, context: Context) {
        ...
        uiView.contentSize = CGSize(width: UIScreen.main.bounds.width  * CGFloat((data.count)), height: UIScreen.main.bounds.height)
        
        for i in 0..<uiView.subviews.count{
            
            uiView.subviews[i].frame = CGRect(x: 0, y: 0,width: UIScreen.main.bounds.width * CGFloat((data.count)), height: UIScreen.main.bounds.height)
        }
    }
    ...
    class Coordinator : NSObject,UIScrollViewDelegate{
        ...
        func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
            ...
            let currenrindex = Int(scrollView.contentOffset.x / UIScreen.main.bounds.width)
